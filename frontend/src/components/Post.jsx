  ...
  return (
    <div className="w-[90%] min-h-[450px] flex flex-col gap-[10px] bg-white items-center shadow-2xl shadow-[#00000058] rounded-2xl pb-[20px]">
      <div className="w-full h-[80px] flex justify-between items-center px-[10px]">
        <div
          className="flex justify-center items-center md:gap-[15px] gap-[10px]"
        ...
        {userData._id != post.author._id && (
          <FollowButton
            tailwind={
              "px-[10px] min:w-[60px] md:min-w-[100px] py-[5px] h-[30px] md:h-[40px] bg-[black] text-white rounded-2xl text-[14px] md:text-[16px]"
            }
      ...
      {post.caption && (
        <div className="w-full justify-between items-center px-[20px] gap-[10px] flex justify-start items-center">
