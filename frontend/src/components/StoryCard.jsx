  ...
  return (
    <div className="w-full max-w-[500px] h-[100vh] border-x-2 border-gray-800 pt-[10px] relative flex flex-col justify-center">
      ...
      {!showViewers && (
        <>
          ...
          {storyData?.author?.userName == userData?.userName && (
            <div
              className="absolute w-full flex items-center gap-[10px] text-white h-[70px] bottom-0 p-2 left-0"
            ...
            >
              ...
              <div className="flex relative">
                {storyData?.viewers?.slice(0, 3).map((viewer, index) => (
                  <div
                    className={`w-[30px] h-[30px]  border-2 border-black rounded-full cursor-pointer overflow-hidden ${index > 0 ? `absolute left-[${index * 9}px]` : ""}`}
                  >
                    <img
      ...
      {showViewers && (
        <>
          <div
            className="w-full  h-[30%] flex items-center justify-center mt-[100px] py-[30px] overflow-hidden"
          ...
          <div className="w-full h-[70%] border-t-2 border-t-gray-800 p-[20px]">
            ...
            <div className="w-full max-h-full flex flex-col gap-[10px] overflow-auto pt-[20px]">
              {storyData?.viewers?.map((viewer, story) => (
